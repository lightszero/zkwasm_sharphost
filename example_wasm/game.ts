...
class Game {
    ...
    DoStep_Put(message: InputMessage_Put): void {
        print("put " + message.color.toString() + "," + message.x.toString() + "," + message.y.toString());
        var v = message.color;
